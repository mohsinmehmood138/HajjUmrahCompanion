...
export const UMRAH_DATA = [
  {
    id: '1',
    heading: 'card_one_heading',
    subheading: 'card_one_subheading',
    backgroundImage: appImages.umrahOne,
    apiKey: PRE_UMRAH,
  },
  {
    id: '2',
    heading: 'card_two_heading',
    subheading: 'card_two_subheading',
    backgroundImage: appImages.umrahTwo,
    apiKey: HAJJ_GUIDE,
  },
  {
    id: '3',
    heading: 'card_three_heading',
    subheading: 'card_three_subheading',
    backgroundImage: appImages.umrahThree,
    apiKey: UMRAH_CHECKLIST,
  },
  {
    id: '4',
    heading: 'card_four_heading',
    subheading: 'card_four_subheading',
...
export const COUNTRY_LANGUAGES = [
  ...
  {id: '3', name: 'Français', code: 'fr', selected: false, isRTL: false},
  {id: '4', name: 'Deutsch', code: 'de', selected: false, isRTL: false},
];
